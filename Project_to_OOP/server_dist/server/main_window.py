...
from Project_to_OOP.server.stat_window import StatWindow
from Project_to_OOP.server.config_window import ConfigWindow
from Project_to_OOP.server.add_user import RegisterUser
from Project_to_OOP.server.remove_user import DelUserDialog
